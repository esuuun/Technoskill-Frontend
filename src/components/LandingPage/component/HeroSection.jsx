      ...
      <div className="relative">
                ...
                >
                  ...
                  {user ? (
                    <div className="flex gap-5">
                      ...
                      <Button
                        className="text-foreground bg-transparent ring-1 ring-ring hover:bg-secondary"
                        onClick={() => logout()}
                      >
        ...
        <section>
          <div className=" max-w-screen-xl mx-auto px-4 py-28 gap-12 overflow-hidden md:px-8 md:flex">
            <motion.div initial={{opacity:0}} animate={{opacity:10}} transition={{duration:2}} className="flex flex-col text-center md:text-start justify-center md:flex-none space-y-5 max-w-xl">
              <div>
                <a
                  href="/"
              ...
              <h1 className="text-4xl  font-extrabold sm:text-5xl ">
                Empower Your Team Management with{" "}
                <span className="underline underline-offset-4 decoration-primary">
                  Team<span className="text-primary">Trackr</span>
                </span>
              </h1>
              <p>
                Easily oversee tasks, track performance, and enhance
                productivity. TeamTrackr helps you keep your team organized and
                efficient.
              </p>
